...
import { CircuitBreakerProtected } from 'src/circuit-breaker/circuit-breaker';
...
export class UserService {
  ...
  public async getMe(userInfo: UserInfoRequestDTO): Promise<UserInfoResponseDTO> {
    ...
    const loyalty: LoyaltyResponseDTO = await this.getLoyaltyByUsername(username);
  ...
  private async getLoyaltyByUsername(username: string): Promise<LoyaltyResponseDTO> {
